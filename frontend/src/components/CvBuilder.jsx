...
export const CvBuilder = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100" style={{ fontFamily: "'Plus Jakarta Sans', 'Inter', system-ui, sans-serif" }}>
      <HeaderNav data={data} onLoadSample={loadSample} onClear={clearAll} />
      ...
      <div className="sticky top-[61px] z-30 flex gap-1 border-b border-slate-200 bg-white p-2 lg:hidden">
        <button
          ...
          className={`flex flex-1 items-center justify-center gap-1.5 rounded-lg py-2 text-sm font-medium transition-colors ${mobileTab === "edit" ? "bg-slate-900 text-white" : "text-slate-600"}`}
        >
        ...
        <button
          ...
          className={`flex flex-1 items-center justify-center gap-1.5 rounded-lg py-2 text-sm font-medium transition-colors ${mobileTab === "preview" ? "bg-slate-900 text-white" : "text-slate-600"}`}
        >
